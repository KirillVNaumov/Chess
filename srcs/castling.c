...
{
    if ((chess->rook_a1_move == 1 && chess->to_move % 2 == 1) || \
        (chess->rook_a8_move == 1 && chess->to_move % 2 == 0))    
        return (-1);
    if (chess->to_move % 2 == 1)
    ...
    if (chess->to_move % 2 == 0)
        if (chess->board[7][4] != '.' || chess->board[7][5] != '.' || \
            chess->board[7][6] != '.')
            return (-1);
    if ((chess->to_move % 2 == 0 && chess->black_king_move == 1) || \
        (chess->to_move % 2 == 1 && chess->white_king_move == 1))
        return (-1);
    return (1);
}
...
{
    if ((chess->rook_h1_move == 1 && chess->to_move % 2 == 1) || \
        (chess->rook_h8_move == 1 && chess->to_move % 2 == 0))    
        return (-1);
    if (chess->to_move % 2 == 1)
